...
import { deployTestInbox, inboxViewsOf } from "../scripts/deploy-test-inbox.js";
...
describe("encode-failure returndata cap", {
  ...
  it("stores at most MAX_ERROR_RETURN_DATA bytes from a large encode revert", async () => {
    ...
    await inbox.write.init([deployer, TARGET_CHAIN_ID, largeReEncode.address, inboxViewsOf(inbox)], {
      account: deployer,
    });
